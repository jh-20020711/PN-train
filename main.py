...
parser.add_argument('--cv_thresh', type=float, default=0.5, help='cv_thresh rate during test')
parser.add_argument('--mean_ratio', type=float, default=-0.1, help='mean_ratio during test')
